...
public class DiveLogController {
    ...
    public ResponseEntity<DiveLogResponseDto> show(@PathVariable Long diveLogId) {
        DiveLogResponseDto dto = diveLogService.showDiveLog(diveLogId);
...
//        Page<DiveLogRequestDto> diveLogDtos = diveLogService.findAllByPagination(
//            pageable);
//
